...
export const TEMPLATES: Record<string, DashboardTemplate> = {
  ...
  onlineshop: {
    ...
    description:
      "Kennzahlen-Set für Shops mit Fokus auf Traffic-Qualität und Performance.",
    ...
    widgets: [
      ...
      {
        type: "text-block",
        title: "Hinweis zur Conversion-Messung",
        layout: { x: 0, y: 2, w: 12, h: 2 },
        config: {
          text:
            "Für echte Conversion-Tracking richte in Matomo Ziele ein (z.B. Bestellung abgeschlossen, Warenkorb-Wert > X €). Dieses Template zeigt nur Traffic-KPIs – Conversion-Widgets folgen, sobald Goals konfiguriert sind.",
          variant: "body",
        },
        position: 5,
      },
      { ...FULL_LINE_CHART, layout: { x: 0, y: 4, w: 12, h: 4 } },
      {
        ...FULL_TOP_PAGES,
